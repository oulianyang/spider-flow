...
![oss - 图1](https://static.bookstack.cn/projects/spiderflow-0.5.0/dd9d9a67022f84f0cec066bb0d05eb2e.svg)
首先到码云下载插件点击下载到本地并导入到工作空间或安装到maven库


#### 使用方法

导入db文件夹sp_oss.sql文件到数据库在 spider-flow-web pom.xml引用
